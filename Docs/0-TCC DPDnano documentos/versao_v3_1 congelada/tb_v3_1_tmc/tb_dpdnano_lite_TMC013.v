...
// TMC013 - Fixed-Point Characterization Benchmark
// Revision : v001
// Based on validated TMC012 v001
// ============================================================================

module tb_dpdnano_lite_TMC013;
...
integer ovf_count;
integer max_abs_in,max_abs_out;
integer abs_out;

real samples_per_clock,cycles_per_sample;
...
initial begin
    ...
    for(tx=0;tx<NUM_SAMPLES;tx=tx+1) begin
        ...
        din_re<=tx;
        din_im<=-tx;
        if(tx>max_abs_in) max_abs_in=tx;
    end
    ...
    $display("==================================================");
    $display("DPDnano-Lite TMC013 v001");
    $display("==================================================");
    ...
    $display("Maximum Input Magnitude : %0d",max_abs_in);
