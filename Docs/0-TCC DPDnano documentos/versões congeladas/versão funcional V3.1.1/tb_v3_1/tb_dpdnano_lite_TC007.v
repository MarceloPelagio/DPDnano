...
initial begin
 ...
 din_re=-16'sh8000; din_im=0;
 coef1_re=16'sh7FFF; coef1_im=0;
 coef3_re=16'sh7FFF; coef3_im=0;
 wait_cycles(5);
 rst=0;
 tb_testcase("TC007","Negative saturation");
 in_valid=1;
 wait_valid();
 in_valid=0;
 expected_re=-16'sh8000;
