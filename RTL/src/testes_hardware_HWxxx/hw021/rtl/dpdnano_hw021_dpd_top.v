...
wire [8:0] count_dpd;
wire [2:0] coef1_index;
wire [2:0] coef3_index;
...
reg out_host_rd_valid_r;
reg in_dpd_rd_valid_r;
...
protocol_controller_hw021_dpd u_protocol (
    .clk(clk_27mhz),
    .rst_n(rst_n),
    .rx_data_i(rx_data),
    .rx_valid_i(rx_valid),
    ...
    .dpd_start_o(start_uart),
    .dpd_start_addr_o(start_addr_uart),
    .dpd_count_o(count_uart),
    .dpd_busy_i(dpd_busy_uart),
    .dpd_done_i(dpd_done_uart),
    .dpd_error_i(dpd_error_uart),
    .dpd_overflow_i(dpd_overflow_uart),
    .coef1_index_o(coef1_index),
    .coef3_index_o(coef3_index),
...
dpd_controller_hw021_dpd u_dpd_controller (
    .clk(clk_dpd),
    .rst(rst_dpd),
    .start_i(start_dpd),
    .start_addr_i(start_addr_dpd),
    .count_i(count_dpd),
    .coef1_index_i(coef1_index),
    .coef3_index_i(coef3_index),
    ...
    .busy_o(dpd_busy_fast),
    .done_o(dpd_done_fast),
    .error_o(dpd_error_fast),
