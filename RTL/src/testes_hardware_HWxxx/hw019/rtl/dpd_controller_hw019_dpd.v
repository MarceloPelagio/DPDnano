...
/*
 * HW019_dpd - base RTL independente derivada do HW018
 *
 * coef1 = +0.90 = 0x7333
 * coef3 = -0.70 = 0xA667
 *
 * O HW019 analitico usa o mesmo comportamento AM/AM do HW018 como
 * referencia experimental para calcular o ganho incremental.
 */

module dpd_controller_hw019_dpd (
    input wire clk,
    input wire rst,
    input wire start_i,
...
localparam signed [`COEF_WIDTH-1:0] COEF1_RE = 16'sh7333;
localparam signed [`COEF_WIDTH-1:0] COEF1_IM = 16'sh0000;
localparam signed [`COEF_WIDTH-1:0] COEF3_RE = 16'shA667;
