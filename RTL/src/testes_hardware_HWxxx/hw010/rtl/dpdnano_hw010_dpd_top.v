...
dpd_controller_hw010_dpd u_dpd_controller (
    .clk(clk_dpd), .rst(rst_dpd),
    .start_i(start_dpd), .start_addr_i(start_addr_dpd), .count_i(count_dpd),
    ...
    .busy_o(dpd_busy_fast), .done_o(dpd_done_fast),
    .error_o(dpd_error_fast), .overflow_seen_o(dpd_overflow_fast)
);
