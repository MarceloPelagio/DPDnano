...
/******************************************************************************
* DPDnano_Lite_v3_2
* HW010_dpd - Cubic branch active
*
* Static coefficients for this characterization:
*
*   coef1 = 0.75 + j0      = 16'sh6000
*   coef3 = 0.125 + j0     = 16'sh1000
*
* The controller is intentionally sequential:
* one memory word is read, one DPD sample is issued, the corresponding
* output is awaited, and then written into output memory.
******************************************************************************/

module dpd_controller_hw010_dpd (
    input  wire       clk,
    input  wire       rst,
