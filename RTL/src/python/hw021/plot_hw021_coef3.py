...
parser.add_argument(
    "--output-amam",
    default="../../results/hw021/hw021_dpd_coef3_amam.png",
)

parser.add_argument(
    "--output-delta",
    default="../../results/hw021/hw021_dpd_coef3_delta.png",
)
...
plt.title(
    "DPDnano-Lite HW021_dpd — Sensibilidade de coef3\n"
...
plt.title(
    "DPDnano-Lite HW021_dpd — Diferença causada por coef3"
)
