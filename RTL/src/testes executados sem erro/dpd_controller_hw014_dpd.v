...
/******************************************************************************
* DPDnano_Lite_v3_2
* HW014_dpd vr02 - Complex Response and AM/PM
*
* Coefficients selected to fit the 4-DSP device limit:
*
*   coef1 = 0,40 + j0,20
*   coef3 = 0,00 + j0,00
*
* Q1.15:
*
*   COEF1_RE = 16'sh3333;  // ≈ 0,40
*   COEF1_IM = 16'sh199A;  // ≈ 0,20
*   COEF3_RE = 16'sh0000;
*   COEF3_IM = 16'sh0000;
*
* The cubic imaginary coefficient produces amplitude-dependent phase rotation.
******************************************************************************/

module dpd_controller_hw014_dpd (
    input  wire       clk,
    input  wire       rst,
    input  wire       start_i,
...
localparam signed [`COEF_WIDTH-1:0] COEF1_IM = 16'sh199A;
