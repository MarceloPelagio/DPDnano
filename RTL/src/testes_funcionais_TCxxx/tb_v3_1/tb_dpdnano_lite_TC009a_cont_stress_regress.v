...
// ============================================================
// TC009A - Continuous Stress Regression
// DPDnano-Lite RTL v3.1 (Frozen)
// Latency measurement standardized
// ============================================================
...
initial begin
 ...
 $display("  Stimulus           : Random I/Q");
 $display("  Samples            : 200");
 $display("  Linear Coef        : 0x4000");
 $display("  Cubic Coef         : 0x0800");
 $display("");
 ...
 if((tx==rx)&&(timeout<5000)&&(pipeline_latency==5)) begin
   $display("TC009 - Continuous Stress ................. PASS");
   $display("");
   ...
   $display("TC009 - Continuous Stress ................. FAIL");
   $display("");
   $display("Vectors Executed : %0d",tx);
